...
public class UserController {
    ...
    @PostMapping
    public Result addUser(@Valid @RequestBody HogwartsUser newHogwartsUser) { //using HogwartsUser to accept new user bc UserDto doesnt have password field, it cant accept request body
