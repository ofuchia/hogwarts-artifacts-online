...
public class ExceptionHandlerAdvice {
    ...
    @ExceptionHandler({UsernameNotFoundException.class, BadCredentialsException.class}) //tells Spring this method is exception handler for this class
    @ResponseStatus(HttpStatus.UNAUTHORIZED) //returns in header
        //customized return, great for if company has own codes
    Result handleAuthenticationException(Exception ex){
        return new Result(false, StatusCode.UNAUTHORIZED, "username or password is incorrect.", ex.getMessage()); //serialized into JSON String
